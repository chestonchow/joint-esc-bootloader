...
// assume 8MHz crystal - use weak attribute to avoid multiple definition errors
__attribute__((weak)) uint32_t SystemCoreClock = 8000000U;

// GPIO helper functions - only define if input_port is defined (i.e., in bootloader/main.c context)
#ifdef input_port
